...
resolver. `start-dev.sh` starts the applications but does not run this
command automatically; invoke it after the stack is ready when a cold local
cache is part of the test.
